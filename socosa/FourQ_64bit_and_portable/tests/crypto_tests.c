...
{ // Test the SchnorrQ digital signature scheme
    ...
    {    
        ...
        msg = "sssssssssssdasssssssssssdafffff";  
        len = 1;
    ...
    printf("DEBUG: average sign time   = [%f] msec\n", ((double) (sign) * 1000 * 1000 ) / (CLOCKS_PER_SEC * TEST_LOOPS) );
    printf("DEBUG: average ver time    = [%f] msec\n", ((double) (ver) * 1000 * 1000 ) / (CLOCKS_PER_SEC * TEST_LOOPS) );
