...
/*
 *  Function:       FIPOSLO_Distill: FIPOSLO's signature distillation
 *
 * 
*/
ECCRYPTO_STATUS FIPOSLO_Distill(struct public_key *pk, size_t SCT_L2,
...
/*
 *  Function:       FIPOSLO_sebver: sebver verification of the valid aggregation signature for FPAS scheme
 *
 * 
*/
ECCRYPTO_STATUS FIPOSLO_sebver(struct public_key pk,
