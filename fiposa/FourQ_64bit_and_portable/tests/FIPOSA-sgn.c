...
/*
 *  Function:       FIPOSA_kg: FIPOSA's key generation
 *
 * sk               secret key
 * pk               public key
 * 
*/
ECCRYPTO_STATUS FIPOSA_kg(struct secret_key *sk, struct public_key *pk)
{
...
/*
 *  Function:       FIPOSA_Sign: FIPOSA's signature generation
 *
 * sk               secret key
 ...
 * 
*/
ECCRYPTO_STATUS FIPOSA_Sign(struct secret_key *sk, size_t depth, size_t SCT_L2,
...
/*
 *  Function:       FIPOSA_Ver: FIPOSA's signature verification
 *
 * 
*/
ECCRYPTO_STATUS FIPOSA_Ver(struct public_key *pk, size_t SCT_L1, size_t SCT_L2,
